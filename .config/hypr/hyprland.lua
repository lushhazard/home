...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd(
		"vopono -v exec --custom-netns-name QBIT --provider custom --custom /etc/wireguard/inazuma-NO-42.conf --protocol wireguard --custom-port-forwarding protonvpn --port-forwarding-callback ~/scripts/qbitport.sh qbittorrent"
	)
